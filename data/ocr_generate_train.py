...
def paddleocr_pipeline(directory):
    ...
    # 指定保存 JSON 的文件路径
    json_file_path = 'path/to/data/LLaVAR/finetune/ocr_llavar_cot_finetune_train.json'
...
# 指定要遍历的文件夹路径
directory_path = 'path/to/data/LLaVAR/finetune/5k-images'
# 调用函数进行遍历
...
# im_show = draw_ocr(image, boxes, txts, scores, font_path='/home/zxy/codes/LLaVA/data/simfang.ttf')
