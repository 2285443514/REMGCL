...
def generate_caption(args):
    ...
    # 指定保存 JSON 的文件路径
    json_file_path = './data/caption_llavar_finetune.json'
...
if __name__ == "__main__":
    args = DynamicObject()
    args.model_path = "path/to/model/llava-v1.5-7b"
    args.model_base = None
    args.image_folder = "path/to/data/LLaVA/finetune/image/train2017"
    args.conv_mode = None
    args.sep = ","
